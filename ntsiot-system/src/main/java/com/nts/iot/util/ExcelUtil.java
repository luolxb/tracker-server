...
import com.nts.iot.annotation.Excel.Type;
import com.nts.iot.annotation.Excels;
import com.nts.iot.config.NtsConfig;
...
public class ExcelUtil<T> {
     ...
     * @return 结果
     */
    public RestResponse exportExcel(List<T> list, String sheetName) {
     ...
     * @return 结果
     */
    public RestResponse importTemplateExcel(String sheetName) {
     ...
     * @return 结果
     */
    public RestResponse exportExcel() {
    ...
    public String encodingFilename(String filename) {
        filename = filename + "_" + DateFormatUtils.format(new Date(), "yyyyMMddHHmmss") + ".xlsx";
        return filename;
    }
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = NtsConfig.getDownloadPath() + filename;
